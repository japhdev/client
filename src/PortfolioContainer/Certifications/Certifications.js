                ...
                <div className="row">
                    <div className="col-lg-12">
                        <div className="pdf-embla">
                            <div className="pdf-embla__viewport" ref={pdfEmblaRef}>
                                <div className="pdf-embla__container">
                                    {certificates.map((cert) => (
                                        <div className="pdf-embla__slide" key={cert.id}>
                                            <div 
...
export default function Certifications(props) {
    ...
    const courses = [
        ...
        },
        {
            ...
            image: "img/certificates/react-cert.jpg",
            certificateUrl: "#",
        ...
        },
        {
            ...
            image: "img/certificates/aws-cert.jpg",
            certificateUrl: "#",
        ...
        },
        {
            ...
            image: "img/certificates/uiux-cert.jpg",
            certificateUrl: "#",
        ...
        },
        {
            ...
            image: "img/certificates/python-cert.jpg",
            certificateUrl: "#",
